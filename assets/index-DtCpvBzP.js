 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(V,Y){var P=V.length;V.push(Y);e:for(;0<P;){var I=P-1>>>1,z=V[I];if(0<i(z,Y))V[I]=Y,V[P]=z,P=I;else break e}}function n(V){return V.length===0?null:V[0]}function r(V){if(V.length===0)return null;var Y=V[0],P=V.pop();if(P!==Y){V[0]=P;e:for(var I=0,z=V.length,W=z>>>1;I<W;){var K=2*(I+1)-1,Q=V[K],X=K+1,G=V[X];if(0>i(Q,P))X<z&&0>i(G,Q)?(V[I]=G,V[X]=P,I=X):(V[I]=Q,V[K]=P,I=K);else if(X<z&&0>i(G,P))V[I]=G,V[X]=P,I=X;else break e}}return Y}function i(V,Y){var P=V.sortIndex-Y.sortIndex;return P!==0?P:V.id-Y.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var l=Date,a=l.now();t.unstable_now=function(){return l.now()-a}}var u=[],h=[],g=1,p=null,m=3,R=!1,N=!1,O=!1,L=typeof setTimeout=="function"?setTimeout:null,C=typeof clearTimeout=="function"?clearTimeout:null,y=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function T(V){for(var Y=n(h);Y!==null;){if(Y.callback===null)r(h);else if(Y.startTime<=V)r(h),Y.sortIndex=Y.expirationTime,e(u,Y);else break;Y=n(h)}}function M(V){if(O=!1,T(V),!N)if(n(u)!==null)N=!0,jn(U);else{var Y=n(h);Y!==null&&Vt(M,Y.startTime-V)}}function U(V,Y){N=!1,O&&(O=!1,C(_),_=-1),R=!0;var P=m;try{for(T(Y),p=n(u);p!==null&&(!(p.expirationTime>Y)||V&&!k());){var I=p.callback;if(typeof I=="function"){p.callback=null,m=p.priorityLevel;var z=I(p.expirationTime<=Y);Y=t.unstable_now(),typeof z=="function"?p.callback=z:p===n(u)&&r(u),T(Y)}else r(u);p=n(u)}if(p!==null)var W=!0;else{var K=n(h);K!==null&&Vt(M,K.startTime-Y),W=!1}return W}finally{p=null,m=P,R=!1}}var B=!1,w=null,_=-1,v=5,S=-1;function k(){return!(t.unstable_now()-S<v)}function A(){if(w!==null){var V=t.unstable_now();S=V;var Y=!0;try{Y=w(!0,V)}finally{Y?E():(B=!1,w=null)}}else B=!1}var E;if(typeof y=="function")E=function(){y(A)};else if(typeof MessageChannel<"u"){var it=new MessageChannel,Bt=it.port2;it.port1.onmessage=A,E=function(){Bt.postMessage(null)}}else E=function(){L(A,0)};function jn(V){w=V,B||(B=!0,E())}function Vt(V,Y){_=L(function(){V(t.unstable_now())},Y)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(V){V.callback=null},t.unstable_continueExecution=function(){N||R||(N=!0,jn(U))},t.unstable_forceFrameRate=function(V){0>V||125<V?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):v=0<V?Math.floor(1e3/V):5},t.unstable_getCurrentPriorityLevel=function(){return m},t.unstable_getFirstCallbackNode=function(){return n(u)},t.unstable_next=function(V){switch(m){case 1:case 2:case 3:var Y=3;break;default:Y=m}var P=m;m=Y;try{return V()}finally{m=P}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(V,Y){switch(V){case 1:case 2:case 3:case 4:case 5:break;default:V=3}var P=m;m=V;try{return Y()}finally{m=P}},t.unstable_scheduleCallback=function(V,Y,P){var I=t.unstable_now();switch(typeof P=="object"&&P!==null?(P=P.delay,P=typeof P=="number"&&0<P?I+P:I):P=I,V){case 1:var z=-1;break;case 2:z=250;break;case 5:z=1073741823;break;case 4:z=1e4;break;default:z=5e3}return z=P+z,V={id:g++,callback:Y,priorityLevel:V,startTime:P,expirationTime:z,sortIndex:-1},P>I?(V.sortIndex=P,e(h,V),n(u)===null&&V===n(h)&&(O?(C(_),_=-1):O=!0,Vt(M,P-I))):(V.sortIndex=z,e(u,V),N||R||(N=!0,jn(U))),V},t.unstable_shouldYield=k,t.unstable_wrapCallback=function(V){var Y=m;return function(){var P=m;m=Y;try{return V.apply(this,arguments)}finally{m=P}}}})(l_);o_.exports=l_;var gE=o_.exports;/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const vR=Math.log(2);class yR{constructor(e){const n=s=>parseInt(Math.log(s)/vR,10),r=s=>parseInt(Array(s+1).join("1"),2);this.count=n(e+1),this.current_=this.count-1;const i=r(this.count);this.bits_=e+1&i}nextBitIsOne(){const e=!(this.bits_&1<<this.current_);return this.current_--,e}}const Ra=function(t,e,n,r){t.sort(e);const i=function(u,h){const g=h-u;let p,m;if(g===0)return null;if(g===1)return p=t[u],m=n?n(p):p,new We(m,p.node,We.BLACK,null,null);{const R=parseInt(g/2,10)+u,N=i(u,R),O=i(R+1,h);return p=t[R],m=n?n(p):p,new We(m,p.node,We.BLACK,N,O)}},s=function(u){let h=null,g=null,p=t.length;const m=function(N,O){const L=p-N,C=p;p-=N;const y=i(L+1,C),T=t[L],M=n?n(T):T;R(new We(M,T.node,O,null,y))},R=function(N){h?(h.left=N,h=N):(g=N,h=N)};for(let N=0;N<u.count;++N){const O=u.nextBitIsOne(),L=Math.pow(2,u.count-(N+1));O?m(L,We.BLACK):(m(L,We.BLACK),m(L,We.RED))}return g},l=new yR(t.length),a=s(l);return new yt(r||e,a)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function RP(t){pk(Xr),Hr(new _r("database",(e,{instanceIdentifier:n})=>{const r=e.getProvider("app").getImmediate(),i=e.getProvider("auth-internal"),s=e.getProvider("app-check-internal");return EP(r,i,s,n)},"PUBLIC").setMultipleInstances(!0)),un(pm,gm,t),un(pm,gm,"esm2017")}Rn.prototype.simpleListen=function(t,e){this.sendRequest("q",{p:t},e)};Rn.prototype.echo=function(t,e){this.sendRequest("echo",{d:t},e)};RP();const NP={apiKey:"AIzaSyCcH6B3SqafCvX_8b4EQvfxhRyZAQFbDSg",authDomain:"ruleta-multiplayer.firebaseapp.com",databaseURL:"https://ruleta-multiplayer-default-rtdb.europe-west1.firebasedatabase.app",projectId:"ruleta-multiplayer",storageBucket:"ruleta-multiplayer.firebasestorage.app",messagingSenderId:"463162815348",appId:"1:463162815348:web:da85d70e198bd72b93f221",measurementId:"G-WQZZ97K6BY"},Af=_y(NP),PP=X1(Af);fk(Af,{localCache:{kind:"persistent",cacheSizeBytes:hk}});const mn=TP(Af),kl=()=>{const t=new Uint32Array(1);return window.crypto.getRandomValues(t),t[0]/4294967296},AP=(t,e)=>{const n=t.length,r=360/n,i=Math.floor(kl()*n),s=t[i],l=7+Math.floor(kl()*4),a=kl()*(r*.8)+r*.1,u=360-i*r-r/2,g=Math.floor(e/360)*360+l*360+u+a,p=5500+Math.floor(kl()*1500);return{targetRotation:g,winnerWedge:s,duration:p}},vw=Oe.createContext(void 0),xP=[{id:"init-1",name:"Sí 👍",color:"#6366f1"},{id:"init-2",name:"No 👎",color:"#f43f5e"}],OP=({children:t})=>{const[e,n]=Oe.useState(null),[r,i]=Oe.useState(null),[s,l]=Oe.useState([]),a=Oe.useRef(null),u=Oe.useRef(null);Oe.useEffect(()=>{const O=sessionStorage.getItem("ruleta_user");O&&n(JSON.parse(O))},[]);const h=async O=>{if(O.trim()){console.log("Iniciando login para:",O);try{const C={id:(await LT(PP)).user.uid,name:O.trim()};console.log("Login exitoso:",C),sessionStorage.setItem("ruleta_user",JSON.stringify(C)),n(C)}catch(L){console.error("Error en login:",L)}}},g=O=>{console.log(`[RTDB Sync] Conectando a la sala: ${O}`);const L=gn(mn,`rooms/${O}`);u.current=_P(L,C=>{const y=C.val();if(!y){console.warn("La sala no existe en la base de datos."),i(null),l([]);return}if(i(y),y.players){const T=Object.entries(y.players).map(([M,U])=>({id:M,...U}));l(T)}else l([])})},p=async()=>{if(e)try{const O=Math.random().toString(36).substring(2,6).toUpperCase(),L=gn(mn,"rooms"),C=gP(L),y=C.key;if(!y)return;const T={id:y,code:O,hostId:e.id,status:"idle",currentRotation:0,targetRotation:0,duration:5e3,wedges:xP,players:{[e.id]:{name:e.name,isHost:!0,online:!0}}};await kc(C,T),await kc(gn(mn,`codes/${O}`),y),console.log(`Sala creada con éxito en RTDB. Código: ${O}`),g(y)}catch(O){console.error("Error al crear la sala en RTDB:",O)}},m=async O=>{if(!e)return{ok:!1,error:"Usuario no autenticado"};const L=O.trim().toUpperCase();try{const y=(await Km(gn(mn,`codes/${L}`))).val();if(!y)return{ok:!1,error:"La sala de juego no existe."};const T=gn(mn,`rooms/${y}/players/${e.id}`);return await kc(T,{name:e.name,isHost:!1,online:!0}),console.log(`Unido con éxito a la sala interna: ${y}`),g(y),{ok:!0}}catch(C){return console.error("Error al unirse por RTDB:",C),{ok:!1,error:"Error de conexión al intentar unirse."}}},R=async O=>{if(r)try{const L=gn(mn,`rooms/${r.id}`);await Rc(L,{wedges:O})}catch(L){console.error("Error actualizando cuñas en RTDB:",L)}},N=async()=>{if(!r||r.status==="spinning"||!e||r.hostId!==e.id)return;const{targetRotation:O,duration:L}=AP(r.wedges,r.currentRotation),C=Date.now();try{const y=gn(mn,`rooms/${r.id}`);await Rc(y,{status:"spinning",targetRotation:O,duration:L,spinStartAt:C}),a.current&&clearTimeout(a.current),a.current=setTimeout(async()=>{const T=await Km(gn(mn,`rooms/${r.id}`));if(!T.exists())return;if(T.val().spinStartAt===C){const U=O%360,B=r.wedges,w=B.length,_=360/w;let v=(270-U)%360;v<0&&(v+=360);const S=Math.floor(v/_)%w,k=B[S]||B[0];console.log(`¡Giro completado! Sincronizado bajo la flecha: ${k.name}`),await Rc(gn(mn,`rooms/${r.id}`),{status:"idle",currentRotation:U,lastResult:{id:k.id,name:k.name,color:k.color,firedAt:Date.now()}})}},L)}catch(y){console.error("Error al ejecutar el spin en la RTDB:",y)}};return Oe.useEffect(()=>()=>{a.current&&clearTimeout(a.current)},[]),$.jsx(vw.Provider,{value:{user:e,room:r,players:s,login:h,createRoom:p,joinRoom:m,updateWedgesInDb:R,spinWheel:N},children:t})},xf=()=>{const t=Oe.useContext(vw);if(!t)throw new Error("useGame debe usarse dentro de GameProvider");return t},DP=()=>{const{room:t}=xf(),e=Oe.useRef(null),n=(t==null?void 0:t.wedges)||[];return Oe.useEffect(()=>{const r=e.current;if(!r||n.length===0)return;const i=r.getContext("2d");if(!i)return;const s=r.width,l=s/2,a=l-10,u=2*Math.PI/n.length;let h;const g=p=>{i.clearRect(0,0,s,s),i.save(),i.translate(l,l);const m=p*Math.PI/180;i.rotate(m),i.translate(-l,-l),n.forEach((R,N)=>{const O=N*u,L=O+u;i.beginPath(),i.moveTo(l,l),i.arc(l,l,a,O,L),i.closePath(),i.fillStyle=R.color||"#334155",i.fill(),i.strokeStyle="#0f172a",i.lineWidth=2,i.stroke(),i.save(),i.translate(l,l),i.rotate(O+u/2),i.textAlign="right",i.textBaseline="middle",i.fillStyle="#ffffff",i.font="bold 14px sans-serif",i.fillText(R.name,a-20,0),i.restore()}),i.restore(),i.beginPath(),i.arc(l,l,18,0,2*Math.PI),i.fillStyle="#0f172a",i.fill(),i.strokeStyle="#38bdf8",i.lineWidth=4,i.stroke()};if((t==null?void 0:t.status)==="spinning"&&t.spinStartAt){const p=t.currentRotation%360,m=t.targetRotation,R=t.duration,N=t.spinStartAt,O=()=>{const C=Date.now()-N;if(C>=R){g(m);return}const y=C/R,T=U=>U*(2-U),M=p+(m-p)*T(y);g(M),h=requestAnimationFrame(O)};O()}else g((t==null?void 0:t.currentRotation)||0);return()=>{h&&cancelAnimationFrame(h)}},[n,t==null?void 0:t.id,t==null?void 0:t.status,t==null?void 0:t.currentRotation,t==null?void 0:t.targetRotation,t==null?void 0:t.spinStartAt,t==null?void 0:t.duration]),$.jsxs("div",{className:"relative w-72 h-72 md:w-96 md:h-96 flex items-center justify-center select-none",children:[$.jsx("div",{className:`absolute -top-4 left-1/2 -translate-x-1/2 z-30 w-0 h-0 
          border-l-[16px] border-l-transparent 
          border-r-[16px] border-r-transparent 
          border-t-[32px] border-t-rose-500 
          drop-shadow-[0_6px_8px_rgba(0,0,0,0.7)]
          transition-transform duration-200
          ${(t==null?void 0:t.status)==="spinning"?"animate-pulse scale-110":""}`}),$.jsx("canvas",{ref:e,width:400,height:400,className:"w-full h-full rounded-full shadow-[0_0_50px_rgba(0,0,0,0.5)] border-4 border-slate-800 z-10"})]})};var Of={};(function t(e,n,r,i){var s=!!(e.Worker&&e.Blob&&e.Promise&&e.OffscreenCanvas&&e.OffscreenCanvasRenderingContext2D&&e.HTMLCanvasElement&&e.HTMLCanvasElement.prototype.transferControlToOffscreen&&e.URL&&e.URL.createObjectURL),l=typeof Path2D=="function"&&typeof DOMMatrix=="function",a=function(){if(!e.OffscreenCanvas)return!1;try{var P=new OffscreenCanvas(1,1),I=P.getContext("2d");I.fillRect(0,0,1,1);var z=P.transferToImageBitmap();I.createPattern(z,"no-repeat")}catch{return!1}return!0}();function u(){}function h(P){var I=n.exports.Promise,z=I!==void 0?I:e.Promise;return typeof z=="function"?new z(P):(P(u,u),null)}var g=function(P,I){return{transform:function(z){if(P)return z;if(I.has(z))return I.get(z);var W=new OffscreenCanvas(z.width,z.height),K=W.getContext("2d");return K.drawImage(z,0,0),I.set(z,W),W},clear:function(){I.clear()}}}(a,new Map),p=function(){var P=Math.floor(16.666666666666668),I,z,W={},K=0;return typeof requestAnimationFrame=="function"&&typeof cancelAnimationFrame=="function"?(I=function(Q){var X=Math.random();return W[X]=requestAnimationFrame(function G(Z){K===Z||K+P-1<Z?(K=Z,delete W[X],Q()):W[X]=requestAnimationFrame(G)}),X},z=function(Q){W[Q]&&cancelAnimationFrame(W[Q])}):(I=function(Q){return setTimeout(Q,P)},z=function(Q){return clearTimeout(Q)}),{frame:I,cancel:z}}(),m=function(){var P,I,z={};function W(K){function Q(X,G){K.postMessage({options:X||{},callback:G})}K.init=function(G){var Z=G.transferControlToOffscreen();K.postMessage({canvas:Z},[Z])},K.fire=function(G,Z,de){if(I)return Q(G,null),I;var pe=Math.random().toString(36).slice(2);return I=h(function(ue){function me(Ae){Ae.data.callback===pe&&(delete z[pe],K.removeEventListener("message",me),I=null,g.clear(),de(),ue())}K.addEventListener("message",me),Q(G,pe),z[pe]=me.bind(null,{data:{callback:pe}})}),I},K.reset=function(){K.postMessage({reset:!0});for(var G in z)z[G](),delete z[G]}}return function(){if(P)return P;if(!r&&s){var K=["var CONFETTI, SIZE = {}, module = {};","("+t.toString()+")(this, module, true, SIZE);","onmessage = function(msg) {","  if (msg.data.options) {","    CONFETTI(msg.data.options).then(function () {","      if (msg.data.callback) {","        postMessage({ callback: msg.data.callback });","      }","    });","  } else if (msg.data.reset) {","    CONFETTI && CONFETTI.reset();","  } else if (msg.data.resize) {","    SIZE.width = msg.data.resize.width;","    SIZE.height = msg.data.resize.height;","  } else if (msg.data.canvas) {","    SIZE.width = msg.data.canvas.width;","    SIZE.height = msg.data.canvas.height;","    CONFETTI = module.exports.create(msg.data.canvas);","  }","}"].join(`
`);try{P=new Worker(URL.createObjectURL(new Blob([K])))}catch(Q){return typeof console<"u"&&typeof console.warn=="function"&&console.warn("🎊 Could not load worker",Q),null}W(P)}return P}}(),R={particleCount:50,angle:90,spread:45,startVelocity:45,decay:.9,gravity:1,drift:0,ticks:200,x:.5,y:.5,shapes:["square","circle"],zIndex:100,colors:["#26ccff","#a25afd","#ff5e7e","#88ff5a","#fcff42","#ffa62d","#ff36ff"],disableForReducedMotion:!1,scalar:1};function N(P,I){return I?I(P):P}function O(P){return P!=null}function L(P,I,z){return N(P&&O(P[I])?P[I]:R[I],z)}function C(P){return P<0?0:Math.floor(P)}function y(P,I){return Math.floor(Math.random()*(I-P))+P}function T(P){return parseInt(P,16)}function M(P){return P.map(U)}function U(P){var I=String(P).replace(/[^0-9a-f]/gi,"");return I.length<6&&(I=I[0]+I[0]+I[1]+I[1]+I[2]+I[2]),{r:T(I.substring(0,2)),g:T(I.substring(2,4)),b:T(I.substring(4,6))}}function B(P){var I=L(P,"origin",Object);return I.x=L(I,"x",Number),I.y=L(I,"y",Number),I}function w(P){P.width=document.documentElement.clientWidth,P.height=document.documentElement.clientHeight}function _(P){var I=P.getBoundingClientRect();P.width=I.width,P.height=I.height}function v(P){var I=document.createElement("canvas");return I.style.position="fixed",I.style.top="0px",I.style.left="0px",I.style.pointerEvents="none",I.style.zIndex=P,I}function S(P,I,z,W,K,Q,X,G,Z){P.save(),P.translate(I,z),P.rotate(Q),P.scale(W,K),P.arc(0,0,1,X,G,Z),P.restore()}function k(P){var I=P.angle*(Math.PI/180),z=P.spread*(Math.PI/180);return{x:P.x,y:P.y,wobble:Math.random()*10,wobbleSpeed:Math.min(.11,Math.random()*.1+.05),velocity:P.startVelocity*.5+Math.random()*P.startVelocity,angle2D:-I+(.5*z-Math.random()*z),tiltAngle:(Math.random()*(.75-.25)+.25)*Math.PI,color:P.color,shape:P.shape,tick:0,totalTicks:P.ticks,decay:P.decay,drift:P.drift,random:Math.random()+2,tiltSin:0,tiltCos:0,wobbleX:0,wobbleY:0,gravity:P.gravity*3,ovalScalar:.6,scalar:P.scalar,flat:P.flat}}function A(P,I){I.x+=Math.cos(I.angle2D)*I.velocity+I.drift,I.y+=Math.sin(I.angle2D)*I.velocity+I.gravity,I.velocity*=I.decay,I.flat?(I.wobble=0,I.wobbleX=I.x+10*I.scalar,I.wobbleY=I.y+10*I.scalar,I.tiltSin=0,I.tiltCos=0,I.random=1):(I.wobble+=I.wobbleSpeed,I.wobbleX=I.x+10*I.scalar*Math.cos(I.wobble),I.wobbleY=I.y+10*I.scalar*Math.sin(I.wobble),I.tiltAngle+=.1,I.tiltSin=Math.sin(I.tiltAngle),I.tiltCos=Math.cos(I.tiltAngle),I.random=Math.random()+2);var z=I.tick++/I.totalTicks,W=I.x+I.random*I.tiltCos,K=I.y+I.random*I.tiltSin,Q=I.wobbleX+I.random*I.tiltCos,X=I.wobbleY+I.random*I.tiltSin;if(P.fillStyle="rgba("+I.color.r+", "+I.color.g+", "+I.color.b+", "+(1-z)+")",P.beginPath(),l&&I.shape.type==="path"&&typeof I.shape.path=="string"&&Array.isArray(I.shape.matrix))P.fill(Vt(I.shape.path,I.shape.matrix,I.x,I.y,Math.abs(Q-W)*.1,Math.abs(X-K)*.1,Math.PI/10*I.wobble));else if(I.shape.type==="bitmap"){var G=Math.PI/10*I.wobble,Z=Math.abs(Q-W)*.1,de=Math.abs(X-K)*.1,pe=I.shape.bitmap.width*I.scalar,ue=I.shape.bitmap.height*I.scalar,me=new DOMMatrix([Math.cos(G)*Z,Math.sin(G)*Z,-Math.sin(G)*de,Math.cos(G)*de,I.x,I.y]);me.multiplySelf(new DOMMatrix(I.shape.matrix));var Ae=P.createPattern(g.transform(I.shape.bitmap),"no-repeat");Ae.setTransform(me),P.globalAlpha=1-z,P.fillStyle=Ae,P.fillRect(I.x-pe/2,I.y-ue/2,pe,ue),P.globalAlpha=1}else if(I.shape==="circle")P.ellipse?P.ellipse(I.x,I.y,Math.abs(Q-W)*I.ovalScalar,Math.abs(X-K)*I.ovalScalar,Math.PI/10*I.wobble,0,2*Math.PI):S(P,I.x,I.y,Math.abs(Q-W)*I.ovalScalar,Math.abs(X-K)*I.ovalScalar,Math.PI/10*I.wobble,0,2*Math.PI);else if(I.shape==="star")for(var ne=Math.PI/2*3,ze=4*I.scalar,ft=8*I.scalar,Ct=I.x,Wt=I.y,nn=5,pt=Math.PI/nn;nn--;)Ct=I.x+Math.cos(ne)*ft,Wt=I.y+Math.sin(ne)*ft,P.lineTo(Ct,Wt),ne+=pt,Ct=I.x+Math.cos(ne)*ze,Wt=I.y+Math.sin(ne)*ze,P.lineTo(Ct,Wt),ne+=pt;else P.moveTo(Math.floor(I.x),Math.floor(I.y)),P.lineTo(Math.floor(I.wobbleX),Math.floor(K)),P.lineTo(Math.floor(Q),Math.floor(X)),P.lineTo(Math.floor(W),Math.floor(I.wobbleY));return P.closePath(),P.fill(),I.tick<I.totalTicks}function E(P,I,z,W,K){var Q=I.slice(),X=P.getContext("2d"),G,Z,de=h(function(pe){function ue(){G=Z=null,X.clearRect(0,0,W.width,W.height),g.clear(),K(),pe()}function me(){r&&!(W.width===i.width&&W.height===i.height)&&(W.width=P.width=i.width,W.height=P.height=i.height),!W.width&&!W.height&&(z(P),W.width=P.width,W.height=P.height),X.clearRect(0,0,W.width,W.height),Q=Q.filter(function(Ae){return A(X,Ae)}),Q.length?G=p.frame(me):ue()}G=p.frame(me),Z=ue});return{addFettis:function(pe){return Q=Q.concat(pe),de},canvas:P,promise:de,reset:function(){G&&p.cancel(G),Z&&Z()}}}function it(P,I){var z=!P,W=!!L(I||{},"resize"),K=!1,Q=L(I,"disableForReducedMotion",Boolean),X=s&&!!L(I||{},"useWorker"),G=X?m():null,Z=z?w:_,de=P&&G?!!P.__confetti_initialized:!1,pe=typeof matchMedia=="function"&&matchMedia("(prefers-reduced-motion)").matches,ue;function me(ne,ze,ft){for(var Ct=L(ne,"particleCount",C),Wt=L(ne,"angle",Number),nn=L(ne,"spread",Number),pt=L(ne,"startVelocity",Number),Ho=L(ne,"decay",Number),wu=L(ne,"gravity",Number),ns=L(ne,"drift",Number),ei=L(ne,"colors",M),$o=L(ne,"ticks",Number),Le=L(ne,"shapes"),$e=L(ne,"scalar"),ti=!!L(ne,"flat"),rs=B(ne),is=Ct,ss=[],Tr=P.width*rs.x,Go=P.height*rs.y;is--;)ss.push(k({x:Tr,y:Go,angle:Wt,spread:nn,startVelocity:pt,color:ei[is%ei.length],shape:Le[y(0,Le.length)],ticks:$o,decay:Ho,gravity:wu,drift:ns,scalar:$e,flat:ti}));return ue?ue.addFettis(ss):(ue=E(P,ss,Z,ze,ft),ue.promise)}function Ae(ne){var ze=Q||L(ne,"disableForReducedMotion",Boolean),ft=L(ne,"zIndex",Number);if(ze&&pe)return h(function(pt){pt()});z&&ue?P=ue.canvas:z&&!P&&(P=v(ft),document.body.appendChild(P)),W&&!de&&Z(P);var Ct={width:P.width,height:P.height};G&&!de&&G.init(P),de=!0,G&&(P.__confetti_initialized=!0);function Wt(){if(G){var pt={getBoundingClientRect:function(){if(!z)return P.getBoundingClientRect()}};Z(pt),G.postMessage({resize:{width:pt.width,height:pt.height}});return}Ct.width=Ct.height=null}function nn(){ue=null,W&&(K=!1,e.removeEventListener("resize",Wt)),z&&P&&(document.body.contains(P)&&document.body.removeChild(P),P=null,de=!1)}return W&&!K&&(K=!0,e.addEventListener("resize",Wt,!1)),G?G.fire(ne,Ct,nn):me(ne,Ct,nn)}return Ae.reset=function(){G&&G.reset(),ue&&ue.reset()},Ae}var Bt;function jn(){return Bt||(Bt=it(null,{useWorker:!0,resize:!0})),Bt}function Vt(P,I,z,W,K,Q,X){var G=new Path2D(P),Z=new Path2D;Z.addPath(G,new DOMMatrix(I));var de=new Path2D;return de.addPath(Z,new DOMMatrix([Math.cos(X)*K,Math.sin(X)*K,-Math.sin(X)*Q,Math.cos(X)*Q,z,W])),de}function V(P){if(!l)throw new Error("path confetti are not supported in this browser");var I,z;typeof P=="string"?I=P:(I=P.path,z=P.matrix);var W=new Path2D(I),K=document.createElement("canvas"),Q=K.getContext("2d");if(!z){for(var X=1e3,G=X,Z=X,de=0,pe=0,ue,me,Ae=0;Ae<X;Ae+=2)for(var ne=0;ne<X;ne+=2)Q.isPointInPath(W,Ae,ne,"nonzero")&&(G=Math.min(G,Ae),Z=Math.min(Z,ne),de=Math.max(de,Ae),pe=Math.max(pe,ne));ue=de-G,me=pe-Z;var ze=10,ft=Math.min(ze/ue,ze/me);z=[ft,0,0,ft,-Math.round(ue/2+G)*ft,-Math.round(me/2+Z)*ft]}return{type:"path",path:I,matrix:z}}function Y(P){var I,z=1,W="#000000",K='"Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji", "EmojiOne Color", "Android Emoji", "Twemoji Mozilla", "system emoji", sans-serif';typeof P=="string"?I=P:(I=P.text,z="scalar"in P?P.scalar:z,K="fontFamily"in P?P.fontFamily:K,W="color"in P?P.color:W);var Q=10*z,X=""+Q+"px "+K,G=new OffscreenCanvas(Q,Q),Z=G.getContext("2d");Z.font=X;var de=Z.measureText(I),pe=Math.ceil(de.actualBoundingBoxRight+de.actualBoundingBoxLeft),ue=Math.ceil(de.actualBoundingBoxAscent+de.actualBoundingBoxDescent),me=2,Ae=de.actualBoundingBoxLeft+me,ne=de.actualBoundingBoxAscent+me;pe+=me+me,ue+=me+me,G=new OffscreenCanvas(pe,ue),Z=G.getContext("2d"),Z.font=X,Z.fillStyle=W,Z.fillText(I,Ae,ne);var ze=1/z;return{type:"bitmap",bitmap:G.transferToImageBitmap(),matrix:[ze,0,0,ze,-pe*ze/2,-ue*ze/2]}}n.exports=function(){return jn().apply(this,arguments)},n.exports.reset=function(){jn().reset()},n.exports.create=it,n.exports.shapeFromPath=V,n.exports.shapeFromText=Y})(function(){return typeof window<"u"?window:typeof self<"u"?self:this||{}}(),Of,!1);const MP=Of.exports;Of.exports.create;const LP=()=>{var m;const{room:t,user:e,players:n,updateWedgesInDb:r,spinWheel:i}=xf(),[s,l]=Oe.useState(""),[a,u]=Oe.useState("#6366f1");if(Oe.useEffect(()=>{t&&t.status==="idle"&&t.lastResult&&(console.log("¡Lanzando confetis globales para:",t.lastResult.name),MP({particleCount:120,spread:70,origin:{y:.6}}))},[t==null?void 0:t.status,(m=t==null?void 0:t.lastResult)==null?void 0:m.firedAt]),!t||!e)return null;const h=t.hostId===e.id,g=async()=>{if(!s.trim())return;const R={id:Math.random().toString(36).substring(2,9),name:s.trim(),color:a};await r([...t.wedges,R]),l("")},p=async R=>{if(t.wedges.length<=2)return;const N=t.wedges.filter(O=>O.id!==R);await r(N)};return $.jsxs("div",{className:"w-full flex flex-col gap-5",children:[t.status==="idle"&&t.lastResult&&$.jsxs("div",{style:{backgroundColor:t.lastResult.color},className:"w-full p-4 rounded-2xl text-center font-black text-white shadow-xl border border-white/20 animate-bounce transition-all duration-300",children:[$.jsx("p",{className:"text-[10px] tracking-widest text-white/70 font-bold uppercase mb-0.5",children:"Resultado Anterior"}),$.jsxs("span",{className:"text-lg",children:["🎉 ¡Ha tocado: ",t.lastResult.name,"! 🏆"]})]}),$.jsxs("div",{className:"w-full bg-slate-900/60 border border-white/10 rounded-3xl p-6 flex flex-col gap-5 backdrop-blur-md",children:[$.jsxs("div",{className:"flex justify-between items-center",children:[$.jsx("h3",{className:"text-sm font-black tracking-wider uppercase bg-gradient-to-r from-indigo-400 to-cyan-400 bg-clip-text text-transparent",children:"Opciones de Ruleta"}),$.jsx("span",{className:"text-[10px] tracking-wide px-2.5 py-1 bg-white/5 border border-white/10 rounded-full font-bold text-slate-400",children:h?"👑 ERES EL HOST":"👁️ MODO ESPECTADOR"})]}),h?$.jsxs($.Fragment,{children:[$.jsxs("div",{className:"flex gap-2",children:[$.jsx("input",{type:"text",value:s,onChange:R=>l(R.target.value),placeholder:"Añadir opción...",className:"flex-1 px-4 py-2.5 bg-slate-950 border border-white/10 rounded-xl text-white text-xs focus:outline-none focus:border-indigo-500"}),$.jsx("input",{type:"color",value:a,onChange:R=>u(R.target.value),className:"w-10 h-10 bg-transparent border-0 cursor-pointer rounded-xl"}),$.jsx("button",{onClick:g,className:"px-4 bg-indigo-600 hover:bg-indigo-500 text-white rounded-xl font-bold",children:"✓"})]}),$.jsx("div",{className:"max-h-[160px] overflow-y-auto space-y-1.5 pr-1",children:t.wedges.map(R=>$.jsxs("div",{className:"flex justify-between items-center p-2.5 bg-slate-950/50 border border-white/5 rounded-xl text-xs",children:[$.jsxs("div",{className:"flex items-center gap-2",children:[$.jsx("div",{className:"w-3 h-3 rounded-full",style:{backgroundColor:R.color}}),$.jsx("span",{className:"text-slate-300 font-medium",children:R.name})]}),$.jsx("button",{onClick:()=>p(R.id),className:"text-slate-500 hover:text-rose-400 font-bold px-1 transition-colors",children:"✕"})]},R.id))}),$.jsx("button",{onClick:i,disabled:t.status==="spinning",className:"w-full py-4 bg-gradient-to-r from-emerald-400 to-teal-400 text-slate-950 font-black tracking-wider uppercase rounded-xl shadow-xl transition-all active:scale-[0.98] disabled:opacity-20 disabled:pointer-events-none text-xs",children:t.status==="spinning"?"🎰 Girando...":"Girar Ruleta 🎲"})]}):$.jsx("p",{className:"text-xs text-slate-400 text-center py-6 border border-dashed border-white/10 rounded-xl bg-slate-950/20",children:"Solo el creador de la sala puede alterar el tablero y girar la rueda."})]}),$.jsxs("div",{className:"w-full bg-slate-900/40 border border-white/10 rounded-3xl p-5 flex flex-col gap-3.5",children:[$.jsxs("div",{className:"flex items-center gap-2",children:[$.jsx("div",{className:"w-2 h-2 rounded-full bg-emerald-500 animate-pulse"}),$.jsxs("h4",{className:"text-xs font-black tracking-wider text-slate-400 uppercase",children:["Jugadores en la Sala (",n.length,")"]})]}),$.jsx("div",{className:"space-y-2 max-h-[180px] overflow-y-auto pr-1",children:n.map(R=>{const N=t.hostId===R.id;return $.jsxs("div",{className:"flex justify-between items-center p-2.5 bg-slate-950/40 border border-white/5 rounded-xl",children:[$.jsxs("div",{className:"flex items-center gap-2.5",children:[$.jsx("div",{className:`w-7 h-7 rounded-full flex items-center justify-center text-[11px] font-black ${N?"bg-amber-500/10 text-amber-400 border border-amber-500/30":"bg-slate-800 text-slate-300"}`,children:R.name?R.name.substring(0,2).toUpperCase():"??"}),$.jsxs("span",{className:"text-xs text-slate-200 font-semibold flex items-center gap-1.5",children:[R.name,R.id===e.id&&$.jsx("span",{className:"text-[10px] text-indigo-400 font-medium bg-indigo-500/10 px-1.5 py-0.2 rounded",children:"(Tú)"})]})]}),$.jsx("span",{className:`text-[9px] font-black px-2 py-0.5 rounded-md tracking-wider uppercase border ${N?"bg-amber-500/20 text-amber-400 border-amber-500/20":"bg-cyan-500/10 text-cyan-400 border-cyan-500/10"}`,children:N?"👑 HOST":"👤 ANÓNIMO"})]},R.id)})})]})]})};function bP(){const{user:t,room:e,login:n,createRoom:r,joinRoom:i}=xf(),[s,l]=Oe.useState(""),[a,u]=Oe.useState(""),[h,g]=Oe.useState(""),[p,m]=Oe.useState(!1),R=async()=>{if(a.trim()){g(""),m(!0),console.log("[App.tsx] Ejecutando handleJoin de forma segura para:",a);try{const N=await i(a);N&&N.ok?console.log("[App.tsx] Unión exitosa confirmada. Esperando renderizado de sala."):(g((N==null?void 0:N.error)??"Error al unirse a la sala"),m(!1))}catch(N){console.error("[App.tsx] Error en handleJoin:",N),g("No se pudo conectar con el servidor."),m(!1)}}};return t?!e||!e.id||!e.hostId?$.jsx("div",{className:"min-h-screen bg-slate-950 flex flex-col items-center justify-center p-4",children:$.jsxs("div",{className:"w-full max-w-sm space-y-4",children:[$.jsx("button",{onClick:()=>{console.log("Click detectado físicamente en el botón de App.tsx"),r()},className:"w-full py-3 bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-slate-950 font-black text-sm rounded-2xl shadow-lg shadow-cyan-500/20 active:scale-[0.98] transition-all uppercase tracking-wider",children:"Crear sala Privada"}),$.jsxs("div",{className:"relative flex items-center p-2 bg-slate-900 border border-white/10 rounded-2xl",children:[$.jsx("input",{type:"text",placeholder:"CÓDIGO DE SALA",value:a,onChange:N=>{u(N.target.value),g("")},onKeyDown:N=>N.key==="Enter"&&R(),maxLength:4,className:"w-full bg-transparent pl-4 pr-20 py-2 text-white font-mono font-bold uppercase tracking-widest outline-none placeholder:text-slate-600 text-sm"}),$.jsx("button",{onClick:R,disabled:p,className:"absolute right-2 px-4 py-2 bg-slate-800 hover:bg-slate-700 text-cyan-400 font-bold text-xs rounded-xl border border-white/5 transition-all disabled:opacity-50",children:p?"...":"Entrar"})]}),h&&$.jsxs("p",{className:"text-center text-xs text-rose-400 font-semibold bg-rose-500/10 border border-rose-500/20 rounded-xl py-2 px-4",children:["⚠️ ",h]})]})}):$.jsxs("div",{className:"min-h-screen bg-slate-950 text-white flex flex-col lg:flex-row items-center justify-center gap-10 p-6",children:[$.jsxs("div",{className:"flex-1 flex flex-col items-center justify-center",children:[$.jsxs("div",{className:"mb-4 bg-slate-900 px-4 py-2 border border-white/10 rounded-xl text-center",children:[$.jsx("p",{className:"text-xs text-slate-400 font-bold",children:"CÓDIGO DE SALA"}),$.jsx("p",{className:"text-xl font-mono font-black text-cyan-400 tracking-widest",children:e.code})]}),$.jsx(DP,{})]}),$.jsx("div",{className:"w-full lg:w-[400px]",children:$.jsx(LP,{})})]}):$.jsx("div",{className:"min-h-screen bg-slate-950 flex flex-col items-center justify-center p-4",children:$.jsxs("div",{className:"w-full max-w-sm bg-slate-900 border border-white/10 rounded-3xl p-6 space-y-4 shadow-2xl",children:[$.jsx("h2",{className:"text-xl font-black text-white text-center tracking-wide uppercase",children:"Ruleta Multiplayer"}),$.jsx("input",{type:"text",placeholder:"Introduce tu Nickname...",value:s,onChange:N=>l(N.target.value),onKeyDown:N=>N.key==="Enter"&&s.trim()&&n(s),className:"w-full px-4 py-3 bg-slate-950 border border-white/10 rounded-xl text-white text-sm focus:outline-none focus:border-indigo-500"}),$.jsx("button",{onClick:()=>s.trim()&&n(s),className:"w-full py-3 bg-indigo-600 hover:bg-indigo-500 text-white font-bold rounded-xl transition-all",children:"Acceder al Lobby"})]})})}Nc.createRoot(document.getElementById("root")).render($.jsx(aE.StrictMode,{children:$.jsx(OP,{children:$.jsx(bP,{})})}));
